...
(add-hook 'prog-mode-hook
          (lambda ()
            (font-lock-add-keywords nil '(("\\<\\(FIXME\\|HACK\\|TODO\\|WIP\\|BUG\\)\\( \\|:\\)" 1 'match t)
                                          (";" . 'shadow)))))
(deftheme standard-calm "A minimal warm dark theme.")
(apply #'custom-theme-set-faces 'standard-calm
       `((fringe ((t :background unspecified)))
         (region ((t :background "lightgoldenrod2" :foreground "#1a1a1a" :extend nil)))
         ...
         (header-line ((t :box t :inherit (highlight default))))
...
(set-face-attribute 'default nil :foreground "#fffbef" :background "#1a1a1a")
(provide-theme 'standard-calm) (enable-theme 'standard-calm)
(keymap-global-set "C-x 6" #'(lambda () (interactive) (invert-face 'default) (frame-set-background-mode nil) (enable-theme 'standard-calm)))
;;; Programming stuff ---
