...
(defface languid-tag
  `((t :height 1.0 :width condensed :weight regular :underline nil))
...
(if load-theme-light
  ...
  (let ((languid-bg      "#1b222d"); "#1b222d" "#181818")  ;; 1B212D
    ...
    (custom-theme-set-faces
     ...
     ;;; howm
     `(action-lock-face ((t (:background "#283243"))))
     `(howm-mode-keyword-face ((t (:foreground ,languid-cyan :underline t))))
     `(howm-mode-title-face ((t (:weight bold :foreground ,languid-yellow))))
     `(howm-mode-ref-face ((t (:inherit howm-mode-keyword-face))))
     `(howm-reminder-today-face ((t (:foreground ,languid-orange))))
     `(howm-reminder-normal-face ((t (:foreground ,languid-red))))
     ...
     `(org-time-grid ((t :foreground ,languid-comment)))
     `(org-agenda-done ((t :foreground ,languid-comment)))
     `(org-agenda-calendar-event ((t :foreground ,languid-green)))
     `(org-agenda-current-time ((t :foreground ,languid-yellow)))
     `(org-imminent-deadline ((t :foreground ,languid-red :italic t)))
     ...
     `(solaire-default-face ((t (:inherit default :background ,languid-solaire))))
     `(solaire-fringe-face ((t (:inherit fringe :background ,languid-solaire))))
     ...
     `(tty-menu-disabled-face ((t (:inherit tooltip :background ,bg-alt))))
     `(tty-menu-enabled-face ((t (:inherit tooltip :background ,bg-alt))))
     `(tty-menu-selected-face ((t (:background ,bg3 :foreground ,languid-fg))))
