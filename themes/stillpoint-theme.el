...
(let ((off-white "#fffffc")     (empty-black "#222323")
  ...
  (custom-theme-set-faces
   ...
   `(fringe
     ((((type tty))            nil)
      (((background dark))     (:background ,empty-black))
      (t                       (:background ,off-white))))
   `(cursor
   ...
   `(homoglyph
     ((t                        nil)))
   `(minibuffer-prompt
     ((t                        (:weight ,(face-attribute 'bold :weight)))))
   `(highlight
   ...
   `(font-lock-function-name-face
     ((((background dark))      (:slant italic)); (:background "gray15"))
      (((background light))     (:slant italic)))); (:background "gray96"))))
   ...
   `(font-lock-warning-face
     ((((background dark))      (:background ,deep-red :weight ,(face-attribute 'bold :weight)))
      (t                        (:background ,faint-red :weight ,(face-attribute 'bold :weight)))))
   `(button
     ((t                        (:inherit (link)))))
   `(link
     ((t                        (:inherit (underline)))))
   ...
   `(header-line
     ((default                  (:inherit (mode-line) :weight ,(face-attribute 'bold :weight)))
...
(defun stillpoint-toggle-theme()
  (interactive)
  (if (eq (frame-parameter nil 'background-mode) 'light)
      (set-frame-parameter nil 'background-mode 'dark)
    (set-frame-parameter nil 'background-mode 'light))
  (enable-theme 'stillpoint))
