...
(with-eval-after-load 'mpc
  ...
  (define-key mpc-tagbrowser-mode-map (kbd "-")
              (lambda nil (interactive) (mpc-change-vol nil)))
  (define-key mpc-tagbrowser-mode-map (kbd "+")
              (lambda nil (interactive) (mpc-change-vol t)))
  (define-key mpc-tagbrowser-mode-map (kbd "p") 'mpc-toggle-play)
  (define-key mpc-tagbrowser-mode-map (kbd "U") 'mpc-update)
